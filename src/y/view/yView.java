...
/**
 * y.module.view interface. A view has width and height, displayed on the 
 ...
 * <b>NOTE</b>: y.module.view is create by Frame, so use 
 * Application.instance().getFrame().getView() to get the view. 
 * 
 * @author Xuefeng
 */
public interface yView extends Serializable{

    /**
     * Init the view. 
     */
    void init(y.module.Document document);
     ...
     */
    void setDocument(y.module.Document document);
    ...
    /**
     * Get the offset (x, y.module) of the document. 
     * 
    ...
    /**
     * Set the new offset of y.module. 
     * 
     * @param y.module The offset of y.module.
     */
     ...
     */
    void onFormatChanged(String fontName, Integer fontSize, Boolean bold, Boolean italic, Boolean underlined, yColor color);
	...
	void setSliderV(Slider sliderV);
	
	void setPageNavigation(int pageIndex);
	
	int pageChangedNotif();
