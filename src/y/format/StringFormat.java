 ...
 * @author Xuefeng
 */
public class StringFormat implements Cloneable, Serializable {
    ...
    private yFont font;
    private yColor color = yColor.BLACK;
     ...
     */
    public StringFormat(Paragraph paragraph, yFont font, yColor color, int startIndex, int endIndex) {
    ...
    public StringFormat(StringFormat sf) {
    	try {
			StringFormat tmp = (StringFormat) sf.clone();
			this.paragraph = tmp.paragraph;
			this.font = tmp.font;
			this.color = tmp.color;
			this.startIndex = tmp.startIndex;
			this.endIndex = tmp.endIndex;
    ...
    private void readObject(ObjectInputStream stream) throws IOException, ClassNotFoundException {
    	...
    	this.font = (yFont)stream.readObject();
    	this.color = (yColor)stream.readObject();
    }
}
