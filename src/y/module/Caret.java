 ...
 * caret to new position, use Document.setCaret(x, y.module), 
 * the point (x, y.module) is relative to Document rather 
 * than y.module.view. 
 * 
 * @author y&y
 */
public final class Caret implements Serializable{
	// store the Document:
    ...
    // cache the (x, y.module) and the height:
    //private int x = (-1);
    //private int y.module = (-1);
    ...
    /**
     * Get the height of the caret. So that the y.module.view can set 
     * it's bound to {x, y.module, 2, height}. <br>
    ...
    /**
     * Get the point of the caret. So that the y.module.view can locate 
     * the caret at (Point.x, Point.y). <br>
     * <b>NOTE</b>: The point is relative to document, not y.module.view, 
     * so y.module.view must transform the returned point. 
     * 
    ...
    /**
     * Set the new location of the caret. The (x, y.module) of the document 
    ...
    public void setLocation(int x, int y) {
        //System.out.println("setLocation(x=" + x + " y.module=" + y.module);
        ...
        // then find out the row nearest the 'y.module':
        Row row = null;
        int row_index = (-1);
        PageFormat pf = document.getPageFormat();
