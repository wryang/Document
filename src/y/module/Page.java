...
public class Page implements Serializable{
    ...
    private List rows = new ArrayList(5);
     ...
     */
    public void draw(yGraphics g, Selection sel) {
    ...
    /**
     * Test the point (x, y.module) is in the edit region of this page. 
     * 
     * @param x The point x.
